...
impl ProjectLoader {
    ...
    fn run_project_loader(&mut self, context: &Arc<RenderContext>) -> Result<Project> {
    ...
    pub fn get_or_load_project(&mut self, context: &Arc<RenderContext>) -> Option<Rc<Project>> {
