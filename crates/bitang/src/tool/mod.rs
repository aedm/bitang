...
pub const _FRAMEDUMP_WIDTH: u32 = 3840;
pub const _FRAMEDUMP_HEIGHT: u32 = 2160;
pub const _FRAMEDUMP_FPS: u32 = 60;

const SCREEN_RATIO: (u32, u32) = (16, 9);

pub const _FRAMEDUMP_PIXEL_FORMAT: PixelFormat = PixelFormat::Rgba8U;
